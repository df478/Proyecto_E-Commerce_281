async function generateResenias() {
  ...
  for (const resenia of reseniasData) {
    resenias.push({
      ...
      calificacion_resenia: resenia.calificacion_resenia,
    });
  }
