...
async function generate() {
  let promociones = [];
  const promocionData = [
    { descuento_promocion: 15, fecha_ini: '2024-01-01', fecha_fin: '2024-01-15', nombre_promocion: 'Año Nuevo Artesanal: Descuento en Tejidos' },
    { descuento_promocion: 2, fecha_ini: '2024-02-10', fecha_fin: '2024-02-20', nombre_promocion: 'Carnaval de Descuentos en Máscaras' },
    { descuento_promocion: 1, fecha_ini: '2024-03-01', fecha_fin: '2024-03-10', nombre_promocion: 'Mes de la Mujer: Joyas Artesanales' },
    { descuento_promocion: 25, fecha_ini: '2024-04-05', fecha_fin: '2024-04-18', nombre_promocion: 'Semana Santa: Ofertas en Productos de Madera' },
    { descuento_promocion: 3, fecha_ini: '2024-05-01', fecha_fin: '2024-05-05', nombre_promocion: 'Día del Trabajador: Descuentos en Aguayos' },
    { descuento_promocion: 4, fecha_ini: '2024-06-10', fecha_fin: '2024-06-20', nombre_promocion: 'Oferta de Invierno: Ponchos y Chompas' },
