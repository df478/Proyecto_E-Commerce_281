...
async function generate() {
  ...
  const productoData = [
    {
        ...
        calificacion: 4, // Calificación específica
        cantidad_calificacion: 50 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 2,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 5, // Calificación específica
    cantidad_calificacion: 75 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 3,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 3, // Calificación específica
    cantidad_calificacion: 30 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 4,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 4, // Calificación específica
    cantidad_calificacion: 40 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 5,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 5, // Calificación específica
    cantidad_calificacion: 20 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 6,
    id_promocion: 10,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 4, // Calificación específica
    cantidad_calificacion: 60 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 7,
    id_promocion: 10,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 5, // Calificación específica
    cantidad_calificacion: 80 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 8,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 4, // Calificación específica
    cantidad_calificacion: 25 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 9,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 3, // Calificación específica
    cantidad_calificacion: 15 // Cantidad de calificaciones específica
  },
  {
    id_artesano: 10,
    id_promocion: null,
    ...
    envio_gratuito: -1, // 1 para sí, 0 para no
    calificacion: 4, // Calificación específica
    cantidad_calificacion: 35 // Cantidad de calificaciones específica
  }
];
  ...
  for (const producto of productoData) {
    productos.push({
      ...
      cantidad_calificacion: producto.cantidad_calificacion
    });
  }
